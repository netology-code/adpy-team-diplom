...
Работа над проектом рассчитана на 10 дней. Для планирования своего времени рекомендуется опираться на 

<details>
  <summary> роадмап:</summary>

![image](https://user-images.githubusercontent.com/53707586/161832746-1c6c42d0-4d64-4d1d-9b05-47b80a3f4a25.png)

  </details>
  
Задание предполагает командную работу для 2 или 3 человек. Поэтому лучше всего разделить задачу между членами команды на разные части программы.
